        ...
        <header class="nav-opt-sprite nav-locate-us nav-lang-en nav-ssl nav-unrec">
            <div class="container-fluid desktop-nav">
                ...
                <div class="row">
                        ...
                        <div class="nav-global-location">
                            <nuxt-link to="/address" class="nav-a nav-a-2">
                                ...
                                <div id="glow-ingress-block">
                                    <span class="nav-line-1" id="glow-ingress-line1">Delivery to</span>
                    ...
                    <!-- Shopping-->
                    <div class="col-xl-5 col-lg-5 col-md-4 col-sm-6 p-0">
                        <div class="nav-fill">
                            <div class="nav-shop">
                    ...
                    <!-- Accounts and Order cart-->
                    <div class="col-xl-5 col-lg-5 col-md-6 col-sm-4 p-0">
                        <div class="nav-tools">

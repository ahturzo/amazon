                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="a-spacing-top-medium">
                            ...
                            <div class="a-row">
                                <!-- Rating -->
                                <no-ssr> <!-- this component will only be rendered on client-side -->
                            ...
                            <div class="headline a-spacing-large">
                                ...
                                <input
                                    type="text"
                                    class="a-input-text"
                                    style="width: 70%;" v-model="headline"
                            ...
                            <div class="a-spacing-base">
                                ...
                                <textarea
                                    ...
                                    style="height:6em; width: 100%;" v-model="body"
                                ></textarea>
                            </div>
                        </div>
                        <br />
                        ...
                        <div class="a-spacing-top-medium">
                            ...
                            <div class="media a-spacing-top-large">
                                ...
                                <div class="media-body pl-3 pt-2">
                                    <input type="text" :value="$auth.$state.user.name" class="a-input-text" style="width: 100%;" />
                                </div>
                            </div>
                        </div>
                        <div class="a-row a-spacing-top-medium">

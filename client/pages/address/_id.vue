                            ...
                            <form>
                                <div class="a-spacing-medium a-spacing-top-medium">
                                    ...
                                    <div class="a-spacing-top-medium">
                                        ...
                                        <input type="text" class="a-input-text" v-model="fullName" :placeholder="address.fullName" style="width: 100%;" />
                                    </div>
                                    <!-- Street Address -->
                                    <div class="a-spacing-top-medium">
                                        ...
                                        <input
                                            ...
                                            style="width: 100%;" :placeholder="address.streetAddress"
                                    ...
                                    <div class="a-spacing-top-medium">
                                        ...
                                        <input type="text" class="a-input-text" v-model="city" :placeholder="address.city" style="width: 100%;" />
                                    </div>
                                    <!-- State -->
                                    <div class="a-spacing-top-medium">
                                        <label style="margin-bottom: 0px;">State / Province / Region</label>
                                        <input type="text" class="a-input-text" v-model="state" :placeholder="address.state" style="width: 100%;" />
                                    </div>
                                    <!-- Zip Code -->
                                    <div class="a-spacing-top-medium">
                                        <label style="margin-bottom: 0px;">Zip Code</label>
                                        <input type="text" class="a-input-text" v-model="zipCode" :placeholder="address.zipCode" style="width: 100%;" />
                                    </div>
                                    <!-- Phone Number -->
                                    <div class="a-spacing-top-medium">
                                        <label style="margin-bottom: 0px;">Phone Number</label>
                                        <input type="text" class="a-input-text" v-model="phoneNumber" :placeholder="address.phoneNumber" style="width: 100%;" />
                                    ...
                                    <div class="a-spacing-top-medium">
                                        ...
                                        <textarea
                                            style="height:6em; width: 100%;" v-model="deliverInstruction" :placeholder="address.deliverInstructions"
                                        ></textarea>
                                    </div>
                                    <!-- Security code -->
                                    <div class="a-spacing-top-medium">
                                        ...
                                        <input type="text" class="a-input-text" v-model="securityCode" style="width: 100%;" :placeholder="address.securityCode" />
                                    </div>
                                    <div class="a-spacing-top-medium">
...
<script>
    export default {
        async asyncData({ $axios, params }) {
            try{
                let countriesResponse = $axios.$get("/api/countries");
                let addressResponse = $axios.$get(`/api/addresses/${params.id}`);
                let [allCountries, singleAddress] = await Promise.all([countriesResponse, addressResponse]);
                return {
        ...
        methods: {
            async onUpdateAddress() {
                try{
                    let streetAddressComplete = "";
                    if(this.streetAddress1 && this.streetAddress2)
                        streetAddressComplete = this.streetAddress1 + " " + this.streetAddress2;
                    else if(this.streetAddress1)
                        streetAddressComplete = this.streetAddress1;
                    else if(this.streetAddress2)
                        streetAddressComplete = this.streetAddress2;
                    let data = {
                        country : this.country,
                        fullName : this.fullName,
                        streetAddress : streetAddressComplete,
                        city : this.city,
                        state : this.state,
